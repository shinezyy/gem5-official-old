...
outdir =  '/home/zyy/gem5-results/full-cnn/'

arch = 'RISCV'

def snn(benchmark, some_extra_args, outdir_b):
...
def main():
    ...
    with open('./history_sensitive.txt') as f:
