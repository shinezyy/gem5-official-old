#ifndef __GL_HASHED_PERCEPTRON_PRED_HH__
#define __GL_HASHED_PERCEPTRON_PRED_HH__
...
/**
 * Implements a global/local history hashed predictor that uses part of the
 * global and local history to hash the corresponding parts of PC to index the
 * counters.  Note that any time a pointer to the bp_history is given, it
 * should be NULL using this predictor because it does not have any branch
 * predictor state that needs to be recorded or updated; the update can be
 * determined solely by the branch being taken or not taken.
 */
class GLHashedPerceptron : public BPredUnit
{
  public:
    /**
     * Default branch predictor constructor.
     */
    GLHashedPerceptron(const GLHashedPerceptronParams *params);
