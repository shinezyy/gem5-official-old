...
void
PerceptronLocalBP::btbUpdate(ThreadID tid, Addr branch_addr,
                             void * &bp_history)
{
...
void
PerceptronLocalBP::update(ThreadID tid, Addr branch_addr,
...
{
    return ((branch_addr >> instShiftAmt) ^ globalHistory) & indexMask;
}
